...
ActionInitialization::ActionInitialization(DetectorConstruction* detector, const char* rootFileName)
 : fDetector(detector), fRootFileName(rootFileName)
{}
...
{
  // Histo manager
  auto   histo = new HistoManager(fRootFileName);
