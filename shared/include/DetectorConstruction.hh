...
class DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    G4double GetCalorSizeXY()    { return fCalorSizeXY; }
  ...
  private:
    ...
    G4double   fWorldSizeXY = 0.;       // will be computed
    G4double   fWorldSizeZ = 0.;        // will be computed
...
inline void DetectorConstruction::ComputeCalorParameters()
{
  // Compute derived parameters of the calorimeter
    ...
    fWorldSizeZ = 1.2*fCalorThickness; fWorldSizeXY = 1.2*fCalorSizeXY;
}
