...
G4VPhysicalVolume* DetectorConstruction::ConstructCalorimeter()
{
  ...
  if (fCalorThickness > 0.)  {
    fSolidCalor = new G4Box("Calorimeter",                //its name
      fCalorSizeXY/2,fCalorSizeXY/2,fCalorThickness/2);   //size
    ...
    fSolidLayer = new G4Box("Layer",                      //its name
      fCalorSizeXY/2,fCalorSizeXY/2,fLayerThickness/2);   //size
  ...
  if (fAbsorberThickness > 0.) {
    fSolidAbsorber = new G4Box("Absorber",                 //its name
      fCalorSizeXY/2,fCalorSizeXY/2,fAbsorberThickness/2); //size
    ...
    fPhysiAbsorber = new G4PVPlacement(nullptr,             //no rotation
                                       G4ThreeVector(0., 0., -fGapThickness/2),  //its position
  ...
  if (fGapThickness > 0.) {
    fSolidGap = new G4Box("Gap",
                          fCalorSizeXY/2,fCalorSizeXY/2,fGapThickness/2);
...
void DetectorConstruction::SetCalorSizeXY(G4double value)
{
